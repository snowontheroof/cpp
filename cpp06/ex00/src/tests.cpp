...
void	testFloat(void)
{
	...
	std::cout << GREEN << "Test input: '" << floatMin_str << "', FLOAT_MIN\n" << RESET;
	...
	std::cout << GREEN << "Test input: '-3402823466385288598117041834845169254400.0f'" << "', FLOAT_MIN * 10\n" << RESET;
	ScalarConverter::convert("-3402823466385288598117041834845169254400.0f");
	std::cout << std::string(50, '-') << std::endl;
...
void	testDouble(void)
{
	...
	std::cout << GREEN << "Test input: '" << doubleMin_str << "', DOUBLE_MIN\n" << RESET;
